...
function MakeAffineDblVector(const V: array of Double): TAffineDblVector; assembler;
...
function MakeDblVector(const V: array of Double): THomogeneousDblVector; assembler;
...
function MakeAffineVector(const V: array of Single): TAffineVector; assembler;
// create a vector from given values
// EAX contains address of V
// ECX contains address to result vector
// EDX contains highest index of V
...
function MakeVector(const V: array of Single): TVector; assembler;
// create a vector from given values
// EAX contains address of V
// ECX contains address to result vector
// EDX contains highest index of V
...
function VectorLength(const V: array of Single): Single; assembler;
...
function VectorNorm(const V: array of Single): Single; assembler;
...
function VectorNormalize(const V: array of Single): Single; assembler;
