...
begin
  ...
  begin
    ...
    DataSource.Name:=TeeGetUniqueName(DataSource.Owner,'DBCrossTabSource'); // Do not localize
  end;
  ...
  TeeTranslateControl(self,[CBValue,CBGroup,CBLabels]);
end;
...
procedure TDBChartCrossTabEditor.Translate;
begin
  TeeTranslateControl(self,[CBValue,CBGroup,CBLabels]);
end;
