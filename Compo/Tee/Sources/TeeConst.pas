...
Const  { do not translate }
   ...
   {$IFDEF AXUNICODE}
   TeeAXMinorVersion         ='.0.0.5 Unicode version';
   {$ELSE}
   TeeAXMinorVersion         ='.0.0.5';
   {$ENDIF}
   AXVer = TeeChartVersion+TeeAXMinorVersion {$IFDEF TEEBETA}+' Beta'{$ENDIF};
   TeeAXBuildVersion         ='09908';

   {$ELSE}

   TeeVCLMinorVersion        ='.06';  // ie: '.01'  '.02' , etc
   TeeVCLBuildVersion        ='60902';
...
var
  ...
  TeeMsg_AsXAML,
  TeeMsg_XAMLFilter,
  TeeMsg_SelectTmpFolder,
  TeeMsg_PathAdobeFlexCompiler,
  TeePolarDegreeSymbol,
  TeeMsg_NewChart,
  TeeMsg_RenameChart,
  TeeMsg_ChartName,
  TeeMsg_SelectTextFile,
  TeeMsg_SaveTextFile,
  TeeMsg_RecordVideo
...
Procedure TeeSetConstants;
begin
  TeeMsg_Copyright          :='© 1995-2009 by Steema Software';
  ...
  TeeMsg_SelectTmpFolder      :='Select temporary folder';
  TeeMsg_PathAdobeFlexCompiler:='Select folder with Adobe Flex mxmlc.exe compiler';
  TeePolarDegreeSymbol        :='°';
  TeeMsg_NewChart             :='New Chart';
  TeeMsg_RenameChart          :='Rename Chart';
  TeeMsg_ChartName            :='Chart Name:';
  TeeMsg_SelectTextFile       :='Select text file';
  TeeMsg_SaveTextFile         :='Save as text file';
