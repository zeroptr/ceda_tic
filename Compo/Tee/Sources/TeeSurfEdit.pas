...
procedure TSurfaceSeriesEditor.FormDestroy(Sender: TObject);
begin
  FreeAndNil(Grid3DForm);
end;

procedure TSurfaceSeriesEditor.CBHideCellsClick(Sender: TObject);
begin
