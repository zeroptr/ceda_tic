...
type
      ...
      PGLUQuadricObj      = {$IFDEF CLR}IntPtr{$ELSE}PGLUQuadric{$ENDIF};
...
[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glColor3f')]
procedure glColor3f(red, green, blue: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glTexEnvi')]
procedure glTexEnvi(target, pname: GLenum; param: GLint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glGetError')]
function glGetError: GLuint; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glMatrixMode')]
procedure glMatrixMode(mode: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLoadIdentity')]
procedure glLoadIdentity; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glOrtho')]
procedure glOrtho(left, right, bottom, top, zNear, zFar: GLdouble); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glDisable')]
procedure glDisable(cap: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glEnable')]
procedure glEnable(cap: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glViewport')]
procedure glViewport(x, y: GLint; width, height: GLsizei); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glClearColor')]
procedure glClearColor(red, green, blue, alpha: GLclampf); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glClear')]
procedure glClear(mask: GLbitfield); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glTranslatef')]
procedure glTranslatef(x, y, z: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glShadeModel')]
procedure glShadeModel(mode: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glRotatef')]
procedure glRotatef(angle, x, y, z: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glVertex2i')]
procedure glVertex2i(x, y: GLint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glVertex3i')]
procedure glVertex3i(x, y, z: GLint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glNormal3i')]
procedure glNormal3i(nx, ny, nz: GLint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glBindTexture')]
procedure glBindTexture(target: GLenum; texture: GLuint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glBegin')]
procedure glBegin(mode: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glTexCoord2f')]
procedure glTexCoord2f(s, t: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glEnd')]
procedure glEnd; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glRasterPos3f')]
procedure glRasterPos3f(x, y, z: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glRasterPos2i')]
procedure glRasterPos2i(x, y: GLInt); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glIsList')]
function glIsList(list: GLuint): GLboolean; external;

{$UNSAFECODE ON}

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glGetIntegerv')]
procedure glGetIntegerv(pname: GLenum; params: PGLint); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glGetDoublev')]
procedure glGetDoublev(pname: GLenum; params: PGLdouble); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glMaterialfv')]
procedure glMaterialfv(face, pname: GLenum; params: PGLfloat); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLightModelfv')]
procedure glLightModelfv(pname: GLenum; params: PGLfloat); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLightfv')]
procedure glLightfv(light, pname: GLenum; params: PGLfloat); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLightf')]
procedure glLightf(light, pname: GLenum; param: GLfloat); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glColor4fv')]
procedure glColor4fv(v: PGLfloat); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glNormal3fv')]
procedure glNormal3fv(v: PGLfloat); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluCylinder')]
procedure gluCylinder(quadObject: IntPtr; baseRadius, topRadius, height: GLdouble; slices, stacks: GLint); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluQuadricOrientation')]
procedure gluQuadricOrientation(quadObject: IntPtr; orientation: GLenum); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluDisk')]
procedure gluDisk(quadObject: IntPtr; innerRadius, outerRadius: GLdouble; slices, loops: GLint); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluQuadricDrawStyle')]
procedure gluQuadricDrawStyle(quadObject: IntPtr; drawStyle: GLenum); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluSphere')]
procedure gluSphere(quadObject: IntPtr; radius: GLdouble; slices, stacks: GLint); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluQuadricTexture')]
procedure gluQuadricTexture(quadObject: IntPtr; textureCoords: GLboolean); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluDeleteQuadric')]
procedure gluDeleteQuadric(state: IntPtr); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluQuadricNormals')]
procedure gluQuadricNormals(quadObject: IntPtr; normals: GLenum); unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluNewQuadric')]
function gluNewQuadric:IntPtr; unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glNormal3dv')]
procedure glNormal3dv(v: PGLdouble); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glVertex3d')]
procedure glVertex3d(x, y, z: GLdouble); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glVertex3dv')]
procedure glVertex3dv(v: PGLdouble); unsafe; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glGetString')]
function glGetString(name: GLenum): PGLubyte; unsafe; external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluProject')]
function gluProject(objx, objy, objz: GLdouble; modelMatrix: TMatrix4d;
         projMatrix: TMatrix4d; viewport: TVector4i;
         winx, winy, winz: PGLdouble): GLint; unsafe; external;

{$UNSAFECODE OFF}

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glCallLists')]
procedure glCallLists(n: GLsizei; atype: GLenum; lists: String); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glDepthFunc')]
procedure glDepthFunc(func: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glColorMaterial')]
procedure glColorMaterial(face: GLenum; mode: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glPolygonOffset')]
procedure glPolygonOffset(factor, units: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glHint')]
procedure glHint(target, mode: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLightModelf')]
procedure glLightModelf(pname: GLenum; param: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glMateriali')]
procedure glMateriali(face, pname: GLenum; param: GLint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLighti')]
procedure glLighti(light, pname: GLenum; param: GLint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glFlush')]
procedure glFlush; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glPushMatrix')]
procedure glPushMatrix; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glPopMatrix')]
procedure glPopMatrix; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLineStipple')]
procedure glLineStipple(factor: GLint; pattern: GLushort); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glLineWidth')]
procedure glLineWidth(width: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glBlendFunc')]
procedure glBlendFunc(sfactor: GLenum; dfactor: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glTexCoord3i')]
procedure glTexCoord3i(s, t, r: GLint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glScalef')]
procedure glScalef(x, y, z: GLfloat); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glListBase')]
procedure glListBase(base: GLuint); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glFrontFace')]
procedure glFrontFace(mode: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glPolygonMode')]
procedure glPolygonMode(face, mode: GLenum); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glDeleteLists')]
procedure glDeleteLists(list: GLuint; range: GLsizei); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glRotated')]
procedure glRotated(angle, x, y, z: GLdouble); external;

[DllImport(OpenGLU32DLL, CharSet = CharSet.Ansi, EntryPoint = 'gluPerspective')]
procedure gluPerspective(fovy, aspect, zNear, zFar: GLdouble); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'glTranslated')]
procedure glTranslated(x, y, z: GLdouble); external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'wglCreateContext')]
function wglCreateContext(DC: HDC): HGLRC; external;

[DllImport(OpenGL32DLL, CharSet = CharSet.Ansi, EntryPoint = 'wglChoosePixelFormat')]
function ChoosePixelFormat(DC: HDC; var PFD:TPixelFormatDescriptor): Integer; external;
...
//------------------------------------------------------------------------------
    ...
    gluErrorString : function(errCode: GLenum): PAnsiChar; stdcall;
    gluGetString : function(name: GLenum): PAnsiChar; stdcall;
...
begin
  ...
  {$IFDEF CLR}
  Buffer:=System.Text.Encoding.ASCII.GetString(glGetString(GL_VERSION));
  {$ELSE}
  Buffer:=StrPas(PAnsiChar(glGetString(GL_VERSION)));
  {$ENDIF}

  tmp:=Pos(' ',Buffer);
  if tmp>0 then
     Delete(Buffer,tmp,Length(Buffer)-tmp+1);
  ...
  begin
    Buffer:=StrPas(gluGetString(GLU_VERSION));
    ...
    begin
      ...
      while (Separator > 0) and
            {$IFDEF D12}
            CharInSet(Buffer[Separator],['0'..'9'])
            {$ELSE}
  ...
  // -- first GL
  Buffer:=StrPas(PAnsiChar(glGetString(GL_EXTENSIONS)));
  ...
  // -- second GLU
  Buffer:=StrPas(gluGetString(GLU_EXTENSIONS));
...
begin
  ...
  PixelFormat:=OpenGL2.ChoosePixelFormat(DC,{$IFNDEF CLR}@{$ENDIF}PFDescriptor);

  if SetPixelFormat(DC,PixelFormat,{$IFNDEF CLR}@{$ENDIF}PFDescriptor) then
  begin
    ...
    Result:=OpenGL2.wglCreateContext(DC);
...
begin
  ...
  if GLHandle > 0 then
  begin
    InternalFreeLibrary(GLHandle);
    GLHandle:=0;
  end;

  if GLUHandle > 0 then
  begin
    InternalFreeLibrary(GLUHandle);
    GLUHandle:=0;
  end;
  {$ENDIF}
...
begin
  ...
  begin
    result:=InitOpenGLFromLibrary(OpenGL32DLL,OpenGLU32DLL);
