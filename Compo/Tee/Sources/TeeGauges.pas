...
const
  TeeHandDistance=30;  // default pixels distance from center to labels
...
var
  ...
  begin
    ...
    begin
      ...
      begin
        tmp:=TotalAngle-((tmpValue-Minimum)*TotalAngle/IRange);
        ...
        repeat
          ...
          begin
            ...
            if assigned(ParentChart.OnGetAxisLabel) then
              ParentChart.OnGetAxisLabel(Axis,nil,AIndex,tmps); // 8.0 TV52010353
...
begin
  result:='TGaugeSeriesEditor'; // Do not localize
end;
