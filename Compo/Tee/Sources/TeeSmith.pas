...
{                                              }
{   Copyright (c) 2000-2009 by Marjan Slatinek }
{        All Rights Reserved                   }
{**********************************************}
unit TeeSmith;
{$I TeeDefs.inc}
...
type
  ...
  protected
    ...
    Procedure DrawLegendShape(ValueIndex:Integer; Const Rect:TRect); override; {  8.0 }
  public
  ...
  published
    ...
    { events }
    property OnGetPointerStyle:TOnGetPointerStyle read FOnGetPointerStyle write FOnGetPointerStyle; // 7.01
  end;
...
begin
  ...
  if FPointer.Visible then
    ...
    begin
      ...
      if Assigned(FOnGetPointerStyle) then // 7.01
         tmpStyle:=FOnGetPointerStyle(Self,t)
      else
         tmpStyle := FPointer.Style;

      FPointer.Draw(CalcXPos(t),CalcYPos(t),tmpColor,tmpStyle);
    end;
end;

procedure TSmithSeries.DrawLegendShape(ValueIndex: Integer; const Rect: TRect);
var tmpColor : TColor;
