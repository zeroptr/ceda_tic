...
begin
  ...
  TeeMsg_FunctionCorrelation  :='Correlaciò';
  TeeMsg_FunctionVariance     :='Variança';
  ...
  TeeMsg_SurfaceNearestTool   :='Celda Superfície';
  TeeMsg_AxisScrollTool       :='Desplaçar Eixos';
  ...
  TeeMsg_FunctionDownSampling :='Reducció';
  ...
  TeeMsg_GammaCorrection  :='Correciò Gamma';
  ...
  // Pro 8.0
  TeeMsg_IsoSurfaceSeries     :='Iso-Superfície';
  TeeMsg_UpToValue            :='Fins a Valor';
  TeeMsg_NoCompression        :='Sense Compressió';
  ...
  TeeMsg_RotateDesc           :='Permetre la rotació del gràfic amb el ratolí.';

  TeeMsg_ImageToolDesc        :='Mostrar una imatge fent servir els límits dels eixos de les Series. La imatge segueix els eixos cuan son arrastrats o maximitzats.';
  TeeMsg_LightToolDesc        :='Mostrar un efecte de llum bi-dimensional sobre el gràfic.';
  TeeMsg_SurfaceNearestDesc   :='Mostrar la celda seleccionada d''una series de superfície al pasar el ratolí per sobre.';
  TeeMsg_AxisScrollDesc       :='Permetre el desplaçament dels eixos arrastrant-los amb el ratolí.';
  TeeMsg_ClipSeriesDesc       :='Restringir el pintat de Series fora dels límits del eixos.';
  TeeMsg_SelectorDesc         :='Permetre seleccionar i arrastrar parts del gràfic i les anotacions.';
  TeeMsg_StatsToolDesc        :='Informe estadístic sobre les dades d''una Series.';
  TeeMsg_PageNumberDesc       :='Mostrar la pàgina actual i el nombre total de pàgines del gràfic.';
  ...
  TeeMsg_LegendScrollDesc     :='Mostrar una barra de desplaçament a la Llegenda del gràfic.';
  ...
  TeeMsg_FullScreenDesc       :='Veure el gràfic maximitzad a pantalla sencera.';

  TeeMsg_MagnifyTool          :='Magnificar';
  TeeMsg_MagnifyToolDesc      :='Magnificar una part del gràfic';

  TeeMsg_Fader                :='Enfosquir';
  TeeMsg_FaderDesc            :='Enfosquir or aclarar un gràfic en forma d''animació.';

  TeeMsg_SubChartTool         :='SubChart';
  TeeMsg_SubChartDesc         :='Molts gràfics dins un sól gràfic';

  TeeMsg_AntiAlias            :='Anti-Alias';
  TeeMsg_AntiAliasDesc        :='Eliminació de l''efecte zig-zag als pixels de les diagonals.';
end;
...
'BLINK DELAY ON=Retard encés'#13+
'BLINK DELAY OFF=Retard apagat'#13+
'SCROLL DIRECTION=Direcciò despl.'#13+
...
'ANTI OVERLAP=Evitar superposició'#13+
...
'CLICK TOLERANCE=Tolerància clics'#13+
...
'INERTIA=Inércia'#13+
'ACCELERATION=Acceleració'#13+
'MAX. STEP=Pas màxim'#13+
'THUMB 1=Botó 1'#13+
'THUMB 2=Botó 2'#13+
'THUMB 3=Botó 3'#13+
'BOUNDS=Tamany'#13+
...
'LOAD=Carregar'#13+
'RENAME=Renombrar'#13+
'LEGEND SYMBOL EDITOR=Editor símbol llegenda'#13+
'NAME=Nom'#13+
'ITALIC=Itàlica'#13+
'BOLD=Negreta'#13+
...
//V8.0
'FONTS=Fonts'#13+
'LEGEND TITLE=Títol Llegenda'#13+
