...
uses
  TeEngine, Series, TeePoEdi, TeeConst;
...
begin
  ...
  begin
    ...
    BColor.LinkProperty(TheSeries,'SeriesColor'); // Do not localize
    RefreshShape;
    ...
    begin
      ...
      (PointerForm as TSeriesPointerEditor).HideSizeOptions;
    end;
  end;
end;
...
begin
  if Showing then
     TheSeries.Pointer.VertSize:=UDPointVertSize.Position;
end;
...
begin
  if Showing then
     TheSeries.Transparency:=UpDown1.Position;
end;

procedure TGanttSeriesEditor.FormDestroy(Sender: TObject);
begin
