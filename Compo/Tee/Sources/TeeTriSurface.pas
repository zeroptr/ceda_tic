...
Type
  ...
  public
    ...
    procedure TrianglePoints(TriangleIndex:Integer; var P:TTrianglePoints3D);  // 7.07
...
begin
  ...
  begin
    ...
    begin
      TrianglePoints(t,P3D);
      TrianglePointsTo2D(P3D,P);
...
procedure TCustomTriSurfaceSeries.TrianglePoints(TriangleIndex:Integer;
                                                 var P:TTrianglePoints3D);
