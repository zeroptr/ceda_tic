...
{ Modified by David Berneda 2000-2007 }
...
Begin
  result:=Word(FastGetByte)+Word(FastGetByte)*256;
End;
...
function PCXGrayValue(const R,G,B:Word):Word;
begin
  result:=((R shl 5)+(G shl 6)+(B*12)) div 108;
end;

{$R-} // 7.05  (because "PalPalEntry" array is [0..0])
