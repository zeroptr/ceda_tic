  ...
  begin
    ...
    begin
      ...
      try
        ...
        begin
          tmpPos:=t+tmpStart-1;
          IXVector[t]:=NotMandatoryValueList.Value[tmpPos]-tmpMinXValue;
...
Begin
  result:=CalcFitting(FPolyDegree,IAnswerVector,X-Source.NotMandatoryValueList.MinValue)+IMinYValue;
end;

{ TCurveFittingFunction }

class function TCurveFittingFunction.GetEditorClass: String;
begin
  result:='TCurveFittingEditor'; // Do not localize
end;
