...
begin
  ...
  TeeMsg_LegendFirstValue   :='Il primo valore della Legenda deve essere > 0';
  TeeMsg_LegendColorWidth   :='L''ampiezza di colore della Legenda deve essere > 0%';
  ...
  TeeMsg_ActionLegendHint       := 'Mostra/Nascondi Legenda';
...
// TeeProCo
  ...
  TeeMsg_ExtraLegendTool      :='Legenda Aggiuntiva';
...
'DEFAULT COLOR=Colore di default'#13+

//V8.0
'LEGEND TITLE=Legend Title'#13+
'DEPTH AXIS=Asse profondità'#13+
'DEPTH TOP AXIS=Depth Top Axis'#13+
'FOOTER=Piè pag.'#13+
'SUBFOOTER=Sub piè pag.'
;
  end;
end;
