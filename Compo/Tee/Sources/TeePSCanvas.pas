...
procedure TEPSCanvas.Arc(const Left, Top, Right, Bottom, StartX, StartY, EndX, EndY: Integer);
begin
  InternalArc(Left,Top,Right,Bottom,StartX,StartY,EndX,EndY, False);
end;
