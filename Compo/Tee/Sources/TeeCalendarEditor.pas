...
procedure TCalendarSeriesEditor.PageControl2Change(Sender: TObject);
begin
  IDays.PC1Change(PageControl2);
end;

procedure TCalendarSeriesEditor.PageControl7Change(Sender: TObject);
begin
  IMonths.PC1Change(PageControl7);
end;

procedure TCalendarSeriesEditor.PageControl6Change(Sender: TObject);
begin
  ITrailing.PC1Change(PageControl6);
end;

procedure TCalendarSeriesEditor.PageControl5Change(Sender: TObject);
begin
  ISunday.PC1Change(PageControl5);
end;

procedure TCalendarSeriesEditor.PageControl4Change(Sender: TObject);
begin
  IToday.PC1Change(PageControl4);
end;

procedure TCalendarSeriesEditor.PageControl3Change(Sender: TObject);
begin
  IWeekDays.PC1Change(PageControl3);
end;
