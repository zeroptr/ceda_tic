...
uses
  ...
  {$ENDIF}
  TeEngine, Series, TeCanvas, TeeProcs, TeeThemes, Chart, TeeAntiAlias;
...
type
  ...
  TWelcomeForm = class(TForm)
    ...
    procedure estExcelTheme1Click(Sender: TObject);
...
begin
  ...
  begin
    ...
    DeltaX:=1;
    DeltaY:=-1;
    SomeText:='For CodeGear RAD Studio, Visual Studio.NET, Delphi, C++ Builder, Java and Kylix';
  end;
...
procedure TWelcomeForm.estExcelTheme1Click(Sender: TObject);
begin
