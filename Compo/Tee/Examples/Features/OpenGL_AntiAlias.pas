...
Constructor TGLCube.Create(ACanvas: TGLCanvas);
begin
  inherited;
  Width:=50;
  Depth:=50;
...
procedure TGLCube.Draw(const X,Y,Z:Double);
...
begin
  ...
  begin
    ...
    begin
      ...
      n:=ScrollBar4.Position;

      c:=TGLCube.Create(Chart1.Canvas as TGLCanvas);
      c.Width:=50;
      c.Height:=5;
      c.Depth:=50;
      ...
      for t:=1 to n do
      begin
        c.Rotation:=t*16.0*TeePiStep;
        c.Draw(300,Chart1.ChartRect.Bottom-c.Height*t,0);
      end;
