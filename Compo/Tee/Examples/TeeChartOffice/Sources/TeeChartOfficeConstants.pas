...
Const
  ...
  TeeChartOfficeVersion      = 'TeeChart Office 3.0';
  TeeMsg_TeeChartOffice      = 'TeeChart Office';
  TeeSteemaMainURL           = TeeChartWeb+'products/TeeChartOffice';
  TeeSteemaSupportURL        = TeeChartWeb+'support/TeeChartOffice';
  TChartOfficeVersionURL     = TeeChartServer+'TeeChartOffice/version.txt';
