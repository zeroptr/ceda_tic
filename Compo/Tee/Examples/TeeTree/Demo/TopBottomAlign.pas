...
type
  TTopBottomAlignForm = class(TBaseForm)
    Panel2: TPanel;
...
procedure TTopBottomAlignForm.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TTopBottomAlignForm.CosmeticProperties;
begin
...
procedure TTopBottomAlignForm.ScrollBar2Change(Sender: TObject);
begin
  SideAlign.VertMargin:=ScrollBar2.Position;
  Tree1.Invalidate;
end;

procedure TTopBottomAlignForm.ScrollBar1Change(Sender: TObject);
begin
...
initialization
  RegisterClass(TTopBottomAlignForm);
end.
