...
OutputBaseFilename=florist_setup_demo
...
[Files]
Source: pi2_demo.exe; DestDir: {app}; Flags: ignoreversion
...
Source: Bosdata\cicek2009.FDB; DestDir: {app}; Flags: onlyifdoesntexist
...
Source: Bosdata\Bosdata.FDB; DestDir: {app}
Source: clienidol\Cclhmd.exe; DestDir: {app}


[Icons]
Name: {group}\FLORIST; Filename: {app}\pi2_demo.exe
Name: {userdesktop}\FLORIST; Filename: {app}\pi2_demo.exe; Tasks: desktopicon

[Run]
Filename: {app}\pi2_demo.exe; Description: {cm:LaunchProgram,FLORIST}; Flags: nowait postinstall skipifsilent
Filename: {sys}\regsvr32.exe; Flags: nowait runhidden 32bit; Tasks: ; Languages: ; Parameters: /s {sys}\PDFCreatorPilot2.dll

[INI]
Filename: {app}\Ayarlar.Ini; Section: Genel; Key: data; String: {app}\CICEK2009.FDB; Flags: createkeyifdoesntexist; Tasks: ; Languages: 
Filename: {app}\Ayarlar.Ini; Section: Yillar; Key: Yil2009; String: {app}\CICEK2009.FDB; Flags: createkeyifdoesntexist; Tasks: ; Languages: 
Filename: {app}\Ayarlar.Ini; Section: AktifYil; Key: AktifY; String: 2009; Flags: createkeyifdoesntexist; Tasks: ; Languages: 
[Dirs]
Name: {app}\Resim
Name: {app}\Yedekler
[UninstallDelete]
Name: {app}\webbc.txt; Type: files
Name: {app}\Yedekler; Type: filesandordirs; Tasks: ; Languages: 
Name: {app}\Ayarlar.ini; Type: files
Name: {app}\desen; Type: filesandordirs
Name: {app}\Resim; Type: filesandordirs
