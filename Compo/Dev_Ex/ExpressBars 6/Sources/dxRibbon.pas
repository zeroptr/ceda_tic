...
function TdxRibbonViewInfo.GetButtonState(AButton: TdxRibbonHitTest): TdxBorderIconState;
  ...
  begin
    case AButton of
      rhtHelpButton: Result := Ribbon.HelpButtonIAccessibilityHelper;
    else
      Result := nil;
    end;
  end;
...
begin
  Result := nil;
  case AIndex of
    0: Result := Ribbon.TabsIAccessibilityHelper.GetHelper;
    1: Result := Ribbon.HelpButtonIAccessibilityHelper.GetHelper;
    2: Result := Ribbon.ApplicationButtonIAccessibilityHelper.GetHelper;
    3: Result := Ribbon.QATIAccessibilityHelper.GetHelper;
  end;
end;
...
begin
  ...
  if AChild = Ribbon.ApplicationButtonIAccessibilityHelper.GetHelper then
    ...
    if AChild = Ribbon.TabsIAccessibilityHelper.GetHelper then
      ...
      if AChild = Ribbon.HelpButtonIAccessibilityHelper.GetHelper then
        Result := 2
      else
...
begin
  ...
  case AIndex of
    ...
    1: Result := Ribbon.HelpButtonIAccessibilityHelper.GetBarHelper;
    2: Result := Ribbon.ApplicationButtonIAccessibilityHelper.GetBarHelper;
    3: Result := Ribbon.QATIAccessibilityHelper.GetBarHelper;
  end;
end;
...
begin
  ...
  if AChild = Ribbon.HelpButtonIAccessibilityHelper.GetBarHelper then
    Exit;
  Inc(Result);
    ...
    andLeft, andRight:
      begin
        ...
        if I <> -1 then
          ...
          if Ribbon.HelpButtonIAccessibilityHelper.GetHelper.Selectable then
            Result := Ribbon.HelpButtonIAccessibilityHelper
          else
            if Ribbon.ApplicationButtonIAccessibilityHelper.GetHelper.Selectable then
              Result := Ribbon.ApplicationButtonIAccessibilityHelper;
      end;
    andUp:
      if Ribbon.QATIAccessibilityHelper = nil then
