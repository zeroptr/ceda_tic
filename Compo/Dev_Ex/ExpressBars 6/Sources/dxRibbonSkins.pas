...
type
  ...
  public
    ...
    procedure DrawContextBackground(DC: HDC; const R: TRect); virtual;
    procedure DrawContextBackgroundGlass(DC: HDC; const R: TRect); virtual;
...
procedure TdxCustomRibbonSkin.DrawContextBackgroundGlass(DC: HDC; const R: TRect);
begin
  if LowColors then
    FillRectByColor(DC, R, clBtnFace) //!!!todo:
  else
