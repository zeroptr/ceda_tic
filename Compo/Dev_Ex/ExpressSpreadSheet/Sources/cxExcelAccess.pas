...
//  end;
  ...
  var
    ...
    function ReadStringChars(ALen: Integer; IsWideChar: Boolean): AnsiString;
    var
      AWChars: WideString;
      AEndsCount: Integer;
      ACount: Integer;
    begin
      ...
      try
        ...
        begin
          ...
          Result := dxStringToAnsiString(AWChars);
    ...
    function ReadNextString: AnsiString;
    var
      ALen: Word;
      AOptions: Byte;
      FormatTokens: Word;
  ...
  begin
    ...
    begin
      ...
      FSharedStringTable.Add(dxAnsiStringToString(ReadNextString));
