...
begin
  ...
  begin
    ...
    Result := dxGpImageClass.CreateFromPattern(Width, Height, ABits, True);
  end;
end;
...
begin
  ...
  begin
    GdipCheck(GdipDrawImageRectRectI(AGraphics, Handle, R.Left, R.Top,
      R.Right - R.Left, R.Bottom - R.Top, 0, 0, Width, Height, UnitPixel,
      nil, nil, nil));
...
begin
  if (Handle <> nil) and dxGpIsRectVisible(Graphics, ADest) then
  begin
