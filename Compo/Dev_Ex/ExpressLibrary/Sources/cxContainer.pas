...
uses
  dxThemeConsts, dxOffice11, cxDWMApi, dxCore, cxGeometry;
...
begin
  Result := 0;
  if not (ANativeStyle or EqualRect(cxGetClientRect(AWindowHandle), AShadowBounds)) then
  begin
