...
begin
  ...
  begin
    ...
    dxNavBarDrawText(Canvas, AText, R, HeaderDrawEdgeFlag or DT_NOPREFIX);
  end;
end;
...
begin
  ...
  begin
    ...
    dxNavBarDrawText(ACanvas, AText, R, DT_LEFT or DT_VCENTER or DT_SINGLELINE);
  end
  else
  begin
...
begin
  ...
  ABitmap := TcxBitmap.CreateSize(cxRectRotate(ADrawRect));
  try
    ACanvas := ABitmap.cxCanvas;
    ...
    ACanvas.Font.Color := ViewInfo.CollapseBarFontColor;
{
    ...
    dxNavBarDrawText(ACanvas.Canvas, AText, ADrawRect, DT_CENTER or DT_VCENTER or DT_SINGLELINE);
    ABitmap.Rotate(raPlus90);
