...
uses
  ...
  Forms, Menus, ImgList, IniFiles,
  dxCore, cxClasses, cxContainer, cxLookAndFeels, cxControls, cxGraphics,
  dxDockConsts;
...
const
  ...
  WM_PURGEPARENT = WM_DX + 2;
  WM_CHECKACTIVEDOCKCONTROL = WM_DX + 3;
...
type
  ...
  private
    ...
    {$ENDIF}
    procedure WMCheckActiveDockControl(var Message: TMessage); message WM_CHECKACTIVEDOCKCONTROL;
...
begin
  Result := (doRedrawOnResize in ControllerOptions) and Painter.NeedRedrawOnResize;
end;
...
begin
  ...
  begin
    if WindowFromPoint(GetMouseCursorPos) = Handle then
      ...
      PostMessage(Handle, WM_CHECKACTIVEDOCKCONTROL, 0, 0);
  end;
end;
...
begin
  ...
  {$IFDEF DELPHI10}
    // A1439
    if Message.Msg = WM_PURGEPARENT then
...
begin
  KillMessages(Handle, WM_DESTROYCONTROLS, WM_DESTROYCONTROLS);
  ...
  begin
    ...
    try
      ...
      begin
        ...
        KillMessages(0, WM_CHECKACTIVEDOCKCONTROL, WM_CHECKACTIVEDOCKCONTROL);
