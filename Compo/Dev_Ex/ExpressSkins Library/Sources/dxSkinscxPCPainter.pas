...
begin
  ...
  begin
    ...
    if ACanvas.Handle = ParentInfo.Canvas.Handle then
      Windows.ExcludeClipRect(ACanvas.Handle, R.Left, R.Top, R.Right, R.Bottom);
  end;
end;
...
begin
  cxDrawTransparentControlBackground(ParentControl, ACanvas, ParentControl.ClientRect, False);
end;
