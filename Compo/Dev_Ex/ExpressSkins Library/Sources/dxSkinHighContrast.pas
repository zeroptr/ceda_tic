...
type
  { TdxHighContrastPainter }
  TdxHighContrastPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
class function TdxHighContrastPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxHighContrastPainter.InternalUnitName: string;
begin
  Result := 'dxSkinHighContrast';
end;
