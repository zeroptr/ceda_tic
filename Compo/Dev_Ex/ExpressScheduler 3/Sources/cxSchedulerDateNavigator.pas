...
type
  ...
  private
    ...
    FCalendar: TcxCustomCalendarTable;
  ...
  protected
    ...
    property Calendar: TcxCustomCalendarTable read FCalendar;
...
begin
  ...
  FCalendar := cxGetLocalCalendar;
  FToday := SysUtils.Date;
  AConvertDate := FCalendar.FromDateTime(FToday);
  AConvertDate.Day := 1;
  FFirstDate := FCalendar.ToDateTime(AConvertDate);
...
destructor TcxSchedulerDateNavigator.Destroy;
begin
...
begin
  Result := FCalendar.GetFirstDayOfWeek(FFirstDate, StartOfWeek);
