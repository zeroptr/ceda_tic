...
uses
  ...
  cxControls, cxContainer, cxClasses, Menus, cxGraphics, cxSchedulerUtils;

const
  WM_REDRAWHEADER = WM_DX + 1;
...
type
  ...
  private
    ...
    procedure WMRedrawHeader(var Msg: TMsg); message WM_REDRAWHEADER;
  protected
    //IcxDialogMetricsInfoData
...
begin
  ...
  PostMessage(Handle, WM_REDRAWHEADER, 0, 0);
