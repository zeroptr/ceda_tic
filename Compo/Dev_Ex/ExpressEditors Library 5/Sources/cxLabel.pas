...
type
  ...
  protected
    ...
    function CalculateTextRect(const R: TRect; const ATextSize: TSize;
      ARealAngle: Integer): TRect; virtual;
...
begin
  ...
  FDrawBitmap := TcxBitmap.CreateSize(0, 0, pf32bit);
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        FDrawBitmap.SetSize(AContentRect);
...
function TcxCustomLabelViewData.CalculateTextRect(const R: TRect;
  const ATextSize: TSize; ARealAngle: Integer): TRect;
begin
  Result := R;
  if IsInplace and not IsLineVisible(ARealAngle) then Exit;
...
begin
  ...
  try
    ...
    begin
      ...
      ARect := CalculateTextRect(ClientRect, ATextSize, ARealAngle);
