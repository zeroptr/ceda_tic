...
begin
  ...
  if APainter = nil then
    APainter := TcxStandardLookAndFeelPainter;
  ...
  APainter.DrawProgressBarText(ACanvas, TextOrientation = cxorVertical,
    SolidTextColor, ABarText, ATextRect, ABarRect, ProgressBarRect, TextColor);
end;
