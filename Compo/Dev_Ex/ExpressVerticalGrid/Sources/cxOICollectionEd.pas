...
uses
  ...
  StdCtrls, Menus, ExtCtrls, ComCtrls, ImgList, ActnList, ToolWin, cxOI, cxClasses;

const
  AM_DeferUpdate = WM_DX + 1;  // avoids break-before-make listview ugliness
...
{$IFDEF DELPHI6}
  Types,
{$ENDIF}
  Registry, TypInfo, cxVGridConsts, dxCore;
