...
private
  ...
  FBusyCursor: {$IFDEF IBO4_BETA}TIB_ScreenCursor{$ELSE}TCursor{$ENDIF};
  FStoreActive: boolean;
  FYieldCursor: {$IFDEF IBO4_BETA}TIB_ScreenCursor{$ELSE}TCursor{$ENDIF};
  FUseCursor: boolean;
  ...
  procedure SetBusyCursor( AValue: {$IFDEF IBO4_BETA}
                                   TIB_ScreenCursor
                                   {$ELSE}
                                   TCursor
                                   {$ENDIF} );
  ...
  procedure SetYieldCursor( AValue: {$IFDEF IBO4_BETA}
                                    TIB_ScreenCursor
                                    {$ELSE}
                                    TCursor
                                    {$ENDIF} );
...
The UseCursor property must be true for this to happen.}
  property BusyCursor: {$IFDEF IBO4_BETA}
                       TIB_ScreenCursor
                       {$ELSE}
                       TCursor
                       {$ENDIF}
...
<br><br>
The UseCursor property must be true for this to happen.}
  property YieldCursor: {$IFDEF IBO4_BETA}
                        TIB_ScreenCursor
                        {$ELSE}
                        TCursor
                        {$ENDIF}
...
procedure TIB_SessionProps.SetBusyCursor( AValue: {$IFDEF IBO4_BETA}
                                                  TIB_ScreenCursor
                                                  {$ELSE}
                                                  TCursor
                                                  {$ENDIF} );
...
procedure TIB_SessionProps.SetYieldCursor( AValue: {$IFDEF IBO4_BETA}
                                                   TIB_ScreenCursor
                                                   {$ELSE}
                                                   TCursor
                                                   {$ENDIF} );
