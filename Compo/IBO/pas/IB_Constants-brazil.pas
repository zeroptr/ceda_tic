...
{ Hints }
  ...
  STR_DDL_coResetExceptionNo = 'Ressetar número de excessão';
  ...
  STR_DDL_coIncludeDebug = 'Incluir comentários de debug';
  STR_DDL_coDescripAsComment = 'Descrições como comentários';
  STR_DDL_coIgnoreDependencies = 'Ignorar dependências';
  STR_DDL_coKeepCustomIndexNames = 'Manter nomes de índices customizados.';
  ...
  E_DDL_BPC_ZERO_IN_CHARSET = 'BytesPerCharacter está zero em charset %s';
  E_DDL_FIELDLEN_MISMATCH  = 'FieldLength %s deveria ser múltiplo de %s bytes por carácter em charset nome %s';
  ...
  E_DDL_CONSTRAINT_NO_INDEX = 'Constraint type %s pode usar um índice, mas não está usando nenhum';
