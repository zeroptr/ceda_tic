...
{ Message constants for various default dialogs used in IBO }
  ...
  M_SCRIPT_ABORT_EXECUTE = 'Abortar a execução deste script?';
  M_SCRIPT_CONTINUE_EXECUTING = 'Continuar executando este script?';
  ...
  M_SCRIPT_SAVE_CHANGES = 'Salvar alterações?';
...
{ Hints }
  ...
  H_RD_actVisible = 'Marque os campos selecionados como visíveis';
  H_RD_actVisibleAll = 'Marque todos os campos selecionados como visíveis';
  H_RD_actUp = 'Mova os campos selecionados uma posição para cima';
  H_RD_actTop = 'Mova os campos selecionados para o topo';
  H_RD_actDown = 'Mova os campos selecionados uma posição para baixo';
  H_RD_actBottom = 'Mova os campos selecionados para baixo';
