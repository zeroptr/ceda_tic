...
type
  TIB_Identifier = array [0..METADATALENGTH - 1] of char;
{ IB7 Support }  
  TIB_Identifier_V2 = array [0..METADATALENGTH_V2 - 1] of char;
...

{
  ...
  void        stdcall isc_print_sqlerror (short,  ISC_STATUS  *
  ...
  Tisc_sqlcode = function( status: PISC_STATUS ): ISC_LONG; stdcall;
  ...
  Tisc_vax_integer = function( a: pchar; b: short): ISC_LONG; stdcall;


  Tisc_portable_integer = function ( a: pbyte;
...
type
 ...
 USER_SEC_DATA = record
  ...
  Tisc_add_user    = function( status: pstatus_vector;
                               UserSecData: PUSER_SEC_DATA ): ISC_LONG; stdcall;
  Tisc_delete_user = function( status: pstatus_vector;
                               UserSecData: PUSER_SEC_DATA ): ISC_LONG; stdcall;
  Tisc_modify_user = function( status: pstatus_vector;
                               UserSecData: PUSER_SEC_DATA ): ISC_LONG; stdcall;
...
ISC_STATUS  stdcall isc_dsql_execute_m (ISC_STATUS  *
					   isc_tr_handle  *
					   isc_stmt_handle  *
					   unsigned short,
					   char  *
...
ISC_STATUS  stdcall isc_dsql_execute2_m (ISC_STATUS  *
					   isc_tr_handle  *
					   isc_stmt_handle  *
					   unsigned short,
					   char  *
...
ISC_STATUS  stdcall isc_dsql_execute_immediate_m (ISC_STATUS  *
						     isc_db_handle  *
						     isc_tr_handle  *
						     unsigned short,
						     char  *
...
ISC_STATUS  stdcall isc_dsql_exec_immed3_m (ISC_STATUS  *
					       isc_db_handle  *
					       isc_tr_handle  *
					       unsigned short,
					       char  *
...
ISC_STATUS  stdcall isc_dsql_fetch_m (ISC_STATUS  *
					 isc_stmt_handle  *
					 unsigned short,
					 char  *
					 unsigned short,
...
{ Removed in IB 5.0
ISC_STATUS  stdcall isc_dsql_fetch2_m (ISC_STATUS  *
					 isc_stmt_handle  *
					 unsigned short,
					 char  *
					 unsigned short,
...
ISC_STATUS  stdcall isc_dsql_insert_m (ISC_STATUS  *
					  isc_stmt_handle  *
					  unsigned short,
					  char  *
					  unsigned short,
...
ISC_STATUS  stdcall isc_dsql_prepare_m (ISC_STATUS  *
					   isc_tr_handle  *
					   isc_stmt_handle  *
					   unsigned short,
					   char  *
...
ISC_STATUS  stdcall isc_dsql_release (ISC_STATUS  *
					 char  *

  T? = function( status:          pstatus_vector;
                 ):               ISC_STATUS; stdcall;

ISC_STATUS  stdcall isc_embed_dsql_close (ISC_STATUS  *
					     char  *

  T? = function( status:          pstatus_vector;
                 ):               ISC_STATUS; stdcall;

ISC_STATUS  stdcall isc_embed_dsql_declare (ISC_STATUS  *
					      char  *
					      char  *
...
ISC_STATUS  stdcall isc_embed_dsql_describe (ISC_STATUS  *
						char  *
						unsigned short,
						XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_describe_bind (ISC_STATUS  *
						     char  *
						     unsigned short,
						     XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_execute (ISC_STATUS  *
					       isc_tr_handle  *
					       char  *
					       unsigned short,
					       XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_execute2 (ISC_STATUS  *
						isc_tr_handle  *
						char  *
						unsigned short,
						XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_execute_immed (ISC_STATUS  *
						     isc_db_handle  *
						     isc_tr_handle  *
						     unsigned short,
						     char  *
...
ISC_STATUS  stdcall isc_embed_dsql_fetch (ISC_STATUS  *
					     char  *
					     unsigned short,
					     XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_open (ISC_STATUS  *
					    isc_tr_handle  *
					    char  *
					    unsigned short,
					    XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_open2 (ISC_STATUS  *
					     isc_tr_handle  *
					     char  *
					     unsigned short,
					     XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_insert (ISC_STATUS  *
					      char  *
					      unsigned short,
					      XSQLDA  *
...
ISC_STATUS  stdcall isc_embed_dsql_prepare (ISC_STATUS  *
					       isc_db_handle  *
					       isc_tr_handle  *
					       char  *
					       unsigned short,
...
ISC_STATUS  stdcall isc_embed_dsql_release (ISC_STATUS  *
					       char  *
...
BSTREAM      * stdcall BLOB_open ( isc_blob_handle;
				   pchar;
				   longint);

int  	    stdcall BLOB_put (char,
				 BSTREAM  *

int  	    stdcall BLOB_close (BSTREAM  *

int  	    stdcall BLOB_get (BSTREAM  *

int         stdcall BLOB_display (ISC_QUAD  *
				     isc_db_handle,
				     isc_tr_handle,
				     char  *

int         stdcall BLOB_dump (ISC_QUAD  *
				  isc_db_handle,
				  isc_tr_handle,
				  char  *

int         stdcall BLOB_edit (ISC_QUAD  *
				  isc_db_handle,
				  isc_tr_handle,
				  char  *

int         stdcall BLOB_load (ISC_QUAD  *
				  isc_db_handle,
				  isc_tr_handle,
				  char  *

int         stdcall BLOB_text_dump (ISC_QUAD  *
				  isc_db_handle,
				  isc_tr_handle,
				  char  *

int         stdcall BLOB_text_load (ISC_QUAD  *
				  isc_db_handle,
				  isc_tr_handle,
				  char  *

BSTREAM      * stdcall Bopen (ISC_QUAD  *
			       	    isc_db_handle,
			       	    isc_tr_handle,
			       	    char  *

BSTREAM      * stdcall Bopen2 (ISC_QUAD  *
				     isc_db_handle,
				     isc_tr_handle,
				     char  *
				     unsigned short);
...
ISC_LONG    stdcall isc_ftof (char  *
				 unsigned short,
				 char  *
				 unsigned short);
...
ISC_STATUS  stdcall isc_print_blr (char  *
				      isc_callback,
				      void  *
				      short);

void        stdcall isc_set_debug (int);

void        stdcall isc_qtoq (ISC_QUAD  *
				 ISC_QUAD  *

void        stdcall isc_vtof (char  *
				 char  *
				 unsigned short);

*)

Tisc_vtov = procedure ( a: pchar; b: pchar; c: short );
...
// if Interbase - they are certainly nothing like the values provided for
// IB6.0
{
...
TDBFField = record
   ...
   FieldType: char;     { type of field - C,N,D,L,etc. }
