...
-----------------------------------------------------------------------------}
// $Id: JvComputerInfoEx.pas 11962 2008-10-16 07:02:19Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_36_PREPARATION/run/JvComputerInfoEx.pas $';
    Revision: '$Revision: 11962 $';
    Date: '$Date: 2008-10-16 09:02:19 +0200 (jeu., 16 oct. 2008) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
