...
{ The checksum field is filled with this while the checksum is computed. }
  AB_TAR_CHKBLANKS = AnsiString('        ');        { 8 blanks, no null }

  AB_TAR_EMPTY_OCT = AnsiString('00000000');

{ The magic field is filled with this if uname and gname are valid. }
  AB_TAR_TMAGIC        = AnsiString('ustar  '#0);   { 7 chars and a null }

{ The magic field is filled with this if this is a GNU format dump entry }
  AB_TAR_GNUMAGIC      = AnsiString('GNUtar '#0);   { 7 chars and a null }
