...
begin
  ...
  begin
    ...
    begin
      Application.MessageBox('Bu modülde yeni Sigorta Þirketi tanýmlama yetkiniz yok.','Dikkat',MB_ICONWARNING);
      exit;
    end;
  end;
  ...
  begin
    Application.MessageBox('Sigorta Þirketi formu açýk.','Dikkat',MB_ICONWARNING);
    Exit;
  end;
end;
