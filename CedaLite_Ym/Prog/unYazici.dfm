object Yazici: TYazici
  ...
  object qryFatura: TIBOQuery
    ...
    SQL.Strings = (
      'SELECT * FROM FAT_IRS '
      'WHERE FAT_IRS_SEP = 1 AND FAT_IRS_ID = 37')
    FieldOptions = []
    Left = 40
    Top = 16
  ...
  object qryFaturaD: TIBOQuery
    ...
    RecordCountAccurate = True
    SQL.Strings = (
      'select * from URUNHAR where fatura_id=37 and fatura_sid=1')
    FieldOptions = []
    Left = 40
    Top = 80
  end
  ...
  object rptYazdir: TfrxReport
    ...
    ReportOptions.CreateDate = 39128.684514421300000000
    ReportOptions.LastChange = 39548.731801574100000000
    ...
    ScriptText.Strings = (
      ...
      'end.')
    StoreInDFM = False
    OnAfterPrintReport = rptYazdirAfterPrintReport
    Left = 392
    Top = 16
  end
  object qryFAT_IRS_ACK: TIBOQuery
    Params = <
      item
        DataType = ftSmallint
        Name = 'PRM_FAT_IRS_SEP'
        ParamType = ptInput
        Value = 0
      end
      item
    ...
    IB_Connection = DataMod.dbaMain
    KeyLinks.Strings = (
      'FAT_IRS_ACK.FAT_IRS_SEP'
      'FAT_IRS_ACK.FAT_IRS_ID'
      'FAT_IRS_ACK.FAT_IRS_SID')
    ReadOnly = True
    RecordCountAccurate = True
    SQL.Strings = (
      'SELECT *'
      'FROM FAT_IRS_ACK'
      'WHERE FAT_IRS_SEP =:PRM_FAT_IRS_SEP '
      '      AND FAT_IRS_ID =:PRM_FAT_IRS_ID '
      '      AND FAT_IRS_SID =:PRM_FAT_IRS_SID;')
    FieldOptions = []
    Left = 132
    Top = 328
  end
