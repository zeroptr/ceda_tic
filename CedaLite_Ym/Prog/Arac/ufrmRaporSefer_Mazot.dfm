object frmRaporSefer_Mazot: TfrmRaporSefer_Mazot
  Left = 251
  Top = 155
  ...
  object qrySefer: TIB_Query
    ...
    FieldsDisplayLabel.Strings = (
      ...
      'MAZOT_FIS_ID=MAzot Fi'#351' No'
      'TUTAR_VPB=Tutar Vpb'
      'MARAC_PLAKA=Ara'#231' Plaka'
      'VEREN_PERSONEL_KOD=Veren Personel Kod'
      'MVEREN_PERSONEL_ADI=Veren Personel Ad'#305
      'ALAN_PERSONEL_KOD=Alan Personel Kod'
      'MALAN_PERSONEL_ADI=Alan Personel Ad'#305
      'ALAN_CARI_KOD=Alan Cari Kod'
      'MALAN_CARI_ADI=Alan Cari Ad'#305
      'MAZOTCU_CARI_KOD=Mazot'#231'u Cari Ad'#305
    ...
    SQL.Strings = (
      ...
      ', S.PERSONEL_KOD '
        ...
        'EFER.PERSONEL_KOD) AS PERSONEL_ADI , S.ALICI_BORC_VPB '
      ', S.SATICI_ALACAK_VPB '
      ', S.BEKLEME_FAT_VPB '
      'FROM SEFER S '
