object frmSefer: TfrmSefer
  ...
  object Pg_Sefer: TPageControl
    ...
    object Ts_Sefer: TTabSheet
      ...
      object Label1: TLabel
        ...
        Width = 108
        Height = 13
        Caption = 'Konteyner Bilgileri Giri'#351'i'
      end
      ...
      object BtnKont_Sil: TButton
        ...
        TabOrder = 32
        TabStop = False
        OnClick = BtnKont_SilClick
      end
      object BtnKont_Iptal: TButton
        Left = 305
        Top = 478
        Width = 56
        Height = 18
        ...
        TabOrder = 31
        TabStop = False
        OnClick = BtnKont_IptalClick
      end
      object BtnKont_Kaydet: TButton
        Left = 249
        Top = 478
        Width = 56
        Height = 18
        ...
        TabOrder = 30
        TabStop = False
        OnClick = BtnKont_KaydetClick
      end
      object BtnKont_Ekle: TButton
        Left = 193
        Top = 478
        Width = 56
        Height = 18
      ...
      object IB_ComboBox3: TIB_ComboBox
        ...
        Height = 21
        AutoLabel.Kind = albTop
        AutoLabel.Caption = 'Konteyn'#305'r Tipi'
        DataField = 'TIP'
        DataSource = dtsKont
        TabOrder = 35
        OnEnter = IB_Edit1Enter
  ...
  object dtsKont: TIB_DataSource
    Dataset = qryKont
    OnStateChanged = dtsKontStateChanged
    Left = 292
    Top = 240
  end
  object qryKont: TIB_Query
    DatabaseName = 'C:\Musteriler\ekinci\TRANSPORT_EKINCI.FDB'
    FieldsDisplayLabel.Strings = (
      'KONT_NO=Konteyner Bilgileri'
      'TIP=Tipi')
    ...
    MasterSearchFlags = [msfOpenMasterOnOpen, msfSearchAppliesToMasterOnly]
    RequestLive = True
    AfterInsert = qryKontAfterInsert
    AfterPost = qryKontAfterPost
    BeforeDelete = qryKontBeforeDelete
    BeforePost = qryKontBeforePost
    BufferSynchroFlags = []
    CachedUpdates = True
    FetchWholeRows = True
    Left = 332
