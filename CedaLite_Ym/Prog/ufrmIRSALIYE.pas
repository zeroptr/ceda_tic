      ...
      1://satýþ irsaliyesi
        begin
          ...
          begin
            ...
            begin
              Application.MessageBox('Bu modülde yeni satýþ irsaliyesi yetkiniz yok.','Dikkat',MB_ICONWARNING);
              exit;
            end;
          end;
        end;
      2://alýþ irsaliyesi
        begin
          ...
          begin
            if ((ISLEM = 0) and (local_can_update = False)) then
            begin
              Application.MessageBox('Bu modülde yeni alýþ irsaliyesi yetkiniz yok.','Dikkat',MB_ICONWARNING);
              exit;
            end;
          end;
        end;
...
//****************************************************************************//
  ...
  begin
    Application.MessageBox('Ýrsaliye formu açýk.','Dikkat',MB_ICONWARNING);
    Exit;
  end;
//****************************************************************************//
  with frmIRSALIYE do
  begin
    ...
    //FAT_PARAMS_ID = 2 SATIÞ ÝRSALÝYESÝ FAT_PARAMS TABLOSUNDA FAT_PARAMS_ID = 2
    ...
    try
      ...
      begin
        Application.MessageBox('Ýrsaliye Parametrelerine Ulaþýlamýyor... Lütfen yazýlým hizmet biriminize durumu bildiriniz. Fatura Giriþi yapmayýnýz.','Dikkat',MB_ICONSTOP);
      end;
...
//****************************************************************************//
    ...
    1:
      begin
        Caption := 'Satýþ Ýrsaliyesi (Sonraki Sayfa Ýçin F6)';
    ...
    2:
      begin
        Caption := 'Alýþ Ýrsaliyesi (Sonraki Sayfa Ýçin F6)';
...
begin
  ...
  begin
    Application.MessageBox('Ýrsaliye bilgileri bölümünde yaptýðýnýz deðiþiklikleri kaydeniniz veya iptal ediniz.','DÝKKAT',MB_ICONWARNING);
    CanClose := False;
  end;
end;
...
{    try
      ...
      begin
        ...
        begin
          Application.MessageBox('Mükerrer Ýrsaliye Numarasý Giriyorsunuz!','Dikkat',MB_ICONINFORMATION);
          IB_Edit3.SetFocus;
          Exit;
        end;
      end;
...
begin
  ...
  begin
    IB_Edit1.SetFocus;
    Application.MessageBox('Ýrsaliye Seri Numarasý Alanýna Veri Girmediniz!!!','DÝKKAT',MB_ICONWARNING);
    exit;
  end;
...
//eklendi.
  ...
  begin
    IB_Edit3.SetFocus;
    Application.MessageBox('Ýrsaliye No Alanýna Veri Girmediniz!!!','DÝKKAT',MB_ICONWARNING);
    exit;
  end;
  ...
  begin
    IB_Edit40.SetFocus;
    Application.MessageBox('Ýrsaliye Açýklamasý Girmediniz!!!','DÝKKAT',MB_ICONWARNING);
    exit;
  end;
  {Lite
  if (Trim(qryFAT_IRS.FieldByName('YEV_ACIKLAMA').AsString) = '') then
  ...
  begin
    Application.MessageBox('Ýrsaliye Kalemi Olmadan Ýrsaliyeyi Kaydedemezsiniz!!!','DÝKKAT',MB_ICONWARNING);
    exit;
  end;
...
begin
  ...
  begin
    Application.MessageBox('Bu seçenek üzerinde Ýrsaliye dýþýnda kopyalama iþlemi yapamazsýnýz.','Dikkat',MB_ICONWARNING);
    exit;
  end;

  if not qryFAT_IRS.Active then
  begin
    Application.MessageBox('Olmayan bir irsaliye üzerinden kopyalama iþlemi yapamazsýnýz.','Dikkat',MB_ICONWARNING);
    exit;
  end;

  if qryFAT_IRS.State in [dssInsert] then
  begin
    Application.MessageBox('Yeni kayýt durumunda irsaliye üzerinden kopyalama iþlemi yapamazsýnýz.','Dikkat',MB_ICONWARNING);
    exit;
  end;
  ...
  begin
    ...
    begin
      Application.MessageBox('Ýrsaliye kopyalama iþlemi sýrasýnda hata oluþtu.','Dikkat',MB_ICONWARNING);
    end;
  end;
